...
class BaseClass extends MaterialTextSelectionControls{

  BaseClass({required this.toolbarItems, this.horizontalPadding = 16, this.verticalPadding = 10}) : assert (toolbarItems.isNotEmpty);

  List<ToolBarItem> toolbarItems;

  // Space between each toolbar items HORIZONTALLY:
  final double horizontalPadding;

  // space between Each toolbar items and Text Selection Toolbar:
  ...
  /// Called when Toolbar menu is pressed or in Actioned:
  ...
  Widget buildToolbar(
    ...
    //ClipboardStatusNotifier clipboardStatus = clipboardStatus;
